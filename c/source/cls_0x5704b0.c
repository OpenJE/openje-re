#include "../include/cls_0x5704b0.h"

void __thiscall cls_0x5704b0::meth_0x5704b0(cls_0x5704b0 *this,uint param_1)

{
  ...
  if (0x25ed097 - this->mbr_0x8 < param_1) {
    local_38 = 0xf;
    local_3c = 0;
    local_4c = 0;
...
void __thiscall cls_0x5704b0::meth_0x572610(cls_0x5704b0 *this,int param_1)

{
  ...
  dVar1 = this->mbr_0x4;
  puVar2 = FUN_0056e130(dVar1,*(undefined4 *)(dVar1 + 4),param_1);
  meth_0x5704b0(this,1);
