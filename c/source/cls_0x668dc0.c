#include "../include/cls_0x668dc0.h"

cls_0x668dc0 * __thiscall cls_0x668dc0::~cls_0x668dc0(cls_0x668dc0 *this)

{
  this->vftptr_0x0 = &cls_0x668dc0__vftable_668dc0_00668dc0;
...
int __thiscall cls_0x668dc0::virt_meth_0x47717d(cls_0x668dc0 *this,int *param_1)
      ...
      if (_Memory != (undefined4 *)0x0) {
        ...
        if (*(int *)(param_1[7] + 0x58) != 0) {
          ...
          do {
            ...
            local_18 = 3;
            do {
              uVar3 = (uint)*(ushort *)(iVar2 + local_c);
              uVar6 = 0;
              if (*(int *)(piVar1[4] + uVar3 * 4) != 0) {
                do {
                  piVar5 = (int *)0x0;
                  if (param_1 != (int *)0x0) {
                    do {
                      if (_Memory[(int)piVar5] ==
                          *(int *)(piVar1[5] + (piVar1[3] * uVar3 + uVar6) * 4)) break;
                  ...
                  if (piVar5 == param_1) {
                    ...
                    _Memory[(int)piVar5] =
                         *(undefined4 *)(piVar1[5] + (piVar1[3] * uVar3 + uVar6) * 4);
                  }
                  uVar6 = uVar6 + 1;
                } while (uVar6 < *(uint *)(piVar1[4] + uVar3 * 4));
              }
              iVar2 = iVar2 + 2;
              local_18 = local_18 + -1;
            } while (local_18 != 0);
...
undefined4 * __thiscall cls_0x668dc0::meth_0x47abbf(cls_0x668dc0 *this,byte param_1)
...
int * __thiscall
cls_0x668dc0::virt_meth_0x48059a
          (cls_0x668dc0 *this,uint param_1,float param_2,float param_3,uint param_4,void *param_5,
...

{
  ...
  if ((((((uint)param_2 & 1) == 0) && (((uint)param_2 & 0x1f001000) == 0)) &&
    ...
    if (local_c == (int **)0x0) {
      ...
      uVar6 = cls_0x474d1a::meth_0x480849(*(cls_0x474d1a **)(param_1 + 0x1c));
      if (-1 < (int)uVar6) {
...
undefined4 __thiscall cls_0x668dc0::virt_meth_0x480992(cls_0x668dc0 *this)
    ...
    if (piVar6[2] != 0) {
      ...
      *(void **)(unaff_EBP + -0x48) = pvVar11;
      if ((((*(int *)(unaff_EBP + -0x5c) != 0) && (*(int *)(unaff_EBP + -0x54) != 0)) &&
        ...
        puVar15 = *(undefined4 **)(unaff_EBP + -0x5c);
        for (uVar17 = uVar9 & 0x3fffffff; uVar17 != 0; uVar17 = uVar17 - 1) {
          *puVar15 = 0;
          puVar15 = puVar15 + 1;
        }
        ...
        puVar15 = *(undefined4 **)(unaff_EBP + -0x54);
        ...
        FUN_004815eb(piVar6,(uint *)(unaff_EBP + -0x74),(int *)(unaff_EBP + -0x78));
        ...
        if (iVar10 == 0) {
          ...
          *(uint *)(unaff_EBP + -100) = uVar17;
          pvVar11 = operator_new(uVar17);
          uVar17 = iVar10 * 0xc;
          *(void **)(unaff_EBP + -0x28) = pvVar11;
          *(uint *)(unaff_EBP + -0x60) = uVar17;
          pvVar11 = operator_new(uVar17);
          *(void **)(unaff_EBP + -0x50) = pvVar11;
          if ((*(int *)(unaff_EBP + -0x28) != 0) && (pvVar11 != (void *)0x0)) {
            ...
            *(undefined4 *)(unaff_EBP + -0x58) = *(undefined4 *)(piVar6[7] + 0x40);
            puVar15 = *(undefined4 **)(unaff_EBP + -0x28);
            for (uVar9 = uVar9 & 0x3fffffff; uVar9 != 0; uVar9 = uVar9 - 1) {
              *puVar15 = 0xffffffff;
              puVar15 = puVar15 + 1;
            }
            for (iVar10 = 0; iVar10 != 0; iVar10 = iVar10 + -1) {
              *(undefined *)puVar15 = 0xff;
              puVar15 = (undefined4 *)((int)puVar15 + 1);
            }
            ...
            *(undefined4 *)(unaff_EBP + -0x24) = 0;
            if (*(int *)(unaff_EBP + -0x4c) != 0) {
              *(undefined4 *)(unaff_EBP + -0x1c) = 0;
              puVar18 = *(uint **)(unaff_EBP + -0x5c);
              *(undefined4 *)(unaff_EBP + -0x34) = *(undefined4 *)(unaff_EBP + -0x58);
              *(uint **)(unaff_EBP + -0x18) = puVar18;
              *(undefined4 *)(unaff_EBP + -0x38) = *(undefined4 *)(unaff_EBP + -0x28);
              do {
                ...
                *(undefined4 *)(unaff_EBP + -0x2c) = 0;
                if (iVar10 != 0) {
                  do {
                    puVar14 = *(ushort **)(unaff_EBP + -0x34);
                    *(ushort **)(unaff_EBP + -0x40) = puVar14;
                    *(undefined4 *)(unaff_EBP + -0x10) = 3;
                    do {
                      uVar17 = (uint)*puVar14;
                      if (*(int *)(unaff_EBP + -0x70) != 0) {
                        uVar17 = *(uint *)(*(int *)(unaff_EBP + -0x44) + uVar17 * 4);
                      }
                      uVar3 = *(uint *)(piVar6[4] + uVar17 * 4);
                      *(uint *)(unaff_EBP + 8) = uVar17;
                      if (uVar9 < uVar3) {
                        iVar10 = (piVar6[3] * uVar17 + uVar9) * 4;
                          ...
                          if (*puVar18 != 0) {
                            ...
                            do {
                              if (*piVar13 == *(int *)(iVar10 + piVar6[5])) {
                                pfVar12 = (float *)(*(int *)(unaff_EBP + -0x50) + uVar17 * 4);
                      ...
                      puVar14 = (ushort *)(*(int *)(unaff_EBP + -0x40) + 2);
                      piVar13 = (int *)(unaff_EBP + -0x10);
                      *piVar13 = *piVar13 + -1;
                      *(ushort **)(unaff_EBP + -0x40) = puVar14;
                    } while (*piVar13 != 0);
                    uVar9 = uVar9 + 1;
                    ...
                    if (2 < *(uint *)(unaff_EBP + -0x20)) {
                      ...
                      *(undefined4 *)(unaff_EBP + 8) = 3;
                      if (3 < *(uint *)(unaff_EBP + -0x20)) {
                        puVar15 = (undefined4 *)(*(int *)(unaff_EBP + -0x38) + 0xc);
                        do {
                          uVar17 = 0;
                          fVar4 = 0.0;
                          if (uVar9 < *puVar18) {
                            *(uint *)(unaff_EBP + -0x14) = *puVar18;
                            do {
                          ...
                          *puVar1 = uVar8;
                          puVar1 = (undefined4 *)(*(int *)(unaff_EBP + -0x50) + iVar10 * 4);
                          uVar8 = *puVar1;
                          puVar2 = (undefined4 *)(*(int *)(unaff_EBP + -0x50) + uVar17 * 4);
                          uVar9 = iVar10 + 1;
                          *puVar1 = *puVar2;
                          *puVar2 = uVar8;
                          puVar18 = *(uint **)(unaff_EBP + -0x18);
                          puVar15 = puVar15 + 1;
                          *(uint *)(unaff_EBP + 8) = uVar9;
                        } while (uVar9 < *(uint *)(unaff_EBP + -0x20));
                      }
                      *puVar18 = *(uint *)(unaff_EBP + -0x20);
                      *(undefined4 *)(unaff_EBP + -0x18) = *(undefined4 *)(unaff_EBP + -0x34);
                      *(undefined4 *)(unaff_EBP + -0x14) = 3;
                      do {
                        fVar4 = 0.0;
                        iVar10 = *(int *)(*(int *)(unaff_EBP + -0x44) +
                                         (uint)**(ushort **)(unaff_EBP + -0x18) * 4);
                        iVar7 = piVar6[4];
                        *(undefined4 *)(unaff_EBP + 8) = 0;
                        iVar16 = iVar10 * 4;
                        if (*(int *)(iVar16 + iVar7) != 0) {
                          do {
                            *(undefined4 *)(unaff_EBP + -0x2c) = 0;
                            if (*puVar18 != 0) {
                              iVar7 = *(int *)(piVar6[5] +
                              ...
                              *(undefined4 *)(unaff_EBP + -0x10) =
                              ...
                              } while (*(uint *)(unaff_EBP + -0x2c) < *puVar18);
                            }
                            if (*(uint *)(unaff_EBP + -0x2c) == *puVar18) {
                          ...
                          } while (*(uint *)(unaff_EBP + 8) < *(uint *)(iVar16 + piVar6[4]));
                          if (NAN(fVar4) == (fVar4 == 0.0)) {
                            iVar7 = piVar6[4];
                            *(undefined4 *)(unaff_EBP + 8) = 0;
                            if (*(int *)(iVar16 + iVar7) != 0) {
                        ...
                        *(int *)(unaff_EBP + -0x18) = *(int *)(unaff_EBP + -0x18) + 2;
                ...
                *(int *)(unaff_EBP + -0x34) = *(int *)(unaff_EBP + -0x34) + 6;
                puVar18 = puVar18 + 1;
                *(uint **)(unaff_EBP + -0x18) = puVar18;
...
int __thiscall cls_0x668dc0::virt_meth_0x48166d(cls_0x668dc0 *this)
  ...
  *(undefined4 *)(unaff_EBP + -0x58) = 2;
  if (((*(byte *)(unaff_EBP + 0xc) & 1) == 0) && ((*(uint *)(unaff_EBP + 0xc) & 0xe0fe2000) == 0)) {
    if (*(int *)((int)this_00 + 8) == 0) {
      ...
      **(undefined4 **)(unaff_EBP + 0x2c) = 0;
      **(undefined4 **)(unaff_EBP + 0x1c) = 0;
      FUN_004815eb(this_00,(uint *)(unaff_EBP + -0x18),(int *)(unaff_EBP + 8));
          ...
          *(void **)(unaff_EBP + -0x34) = pvVar7;
          if (((*(int *)(unaff_EBP + -0x10) != 0) && (*(int *)(unaff_EBP + -0x38) != 0)) &&
              ...
              *(undefined4 *)(unaff_EBP + -0x1c) = *(undefined4 *)(unaff_EBP + -0x4c);
              do {
                ...
                *(undefined4 *)(unaff_EBP + -0x2c) = 3;
                do {
                  uVar12 = (uint)*(ushort *)
                                  (*(int *)(unaff_EBP + -0x14) + *(int *)(unaff_EBP + -0x50));
                  uVar6 = *(uint *)(*(int *)((int)this_00 + 0x10) + uVar12 * 4);
                  *(uint *)(unaff_EBP + -0x10) = uVar6;
                  ...
                  if (*(int *)(unaff_EBP + -0x10) != 0) {
                    do {
                      uVar1 = *(uint *)(*(int *)((int)this_00 + 0x14) +
                                       (*(int *)((int)this_00 + 0xc) * uVar12 + uVar6) * 4);
                      puVar16 = (uint *)(*(int *)(unaff_EBP + -0x24) + (uVar1 >> 5) * 4);
                      *puVar16 = *puVar16 | 1 << ((byte)uVar1 & 0x1f);
                      uVar6 = uVar6 + 1;
                    } while (uVar6 < *(uint *)(unaff_EBP + -0x10));
                  }
                  *(int *)(unaff_EBP + -0x14) = *(int *)(unaff_EBP + -0x14) + 2;
            ...
            *(uint *)(unaff_EBP + -0x58) = uVar6 | uVar12 & 0xffffeff1;
            iVar4 = cls_0x474d1a::meth_0x480849(this_01);
            if (iVar4 == 0) {
              piVar11 = *(int **)(unaff_EBP + 0x1c);
