#include "../include/cls_0x4491f0.h"

cls_0x4491f0 * __thiscall
cls_0x4491f0::cls_0x4491f0(cls_0x4491f0 *this,_String_base *param_1,int param_2)

{
  ...
  *(int *)(iVar1 + -4 + (int)this) = iVar1 + -0xc;
  ...
  pcVar2 = "Options_Multiplayer.INT";
  do {
    pcVar3 = pcVar2;
    pcVar2 = pcVar3 + 1;
  } while (*pcVar3 != '\0');
  ::cls_0x50db20::meth_0x401bd0
            ((cls_0x50db20 *)&local_28,"Options_Multiplayer.INT",(uint)(pcVar3 + -0x65abac));
  local_4._0_1_ = 2;
  ...
  ::cls_0x50db20::meth_0x401bd0
            ((cls_0x50db20 *)&local_28,"picBackground",(uint)(pcVar3 + -0x650ac0));
