#include "../include/cls_0x5658f0.h"

undefined4 __thiscall cls_0x5658f0::meth_0x49edc0(cls_0x5658f0 *this,uint param_1)
...
cls_0x5658f0 * __thiscall cls_0x5658f0::cls_0x5658f0(cls_0x5658f0 *this,int param_1)

{
  ...
  uVar2 = meth_0x49edc0(this,uVar1);
  if ((char)uVar2 != '\0') {
    local_8 = 0;
