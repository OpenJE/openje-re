#include "../include/cls_0x6b86d4.h"

void __thiscall
cls_0x6b86d4::virt_meth_0x5d93c7(cls_0x6b86d4 *this,uint param_1,uint param_2,int param_3)
...
void __thiscall
cls_0x6b86d4::virt_meth_0x5da627(cls_0x6b86d4 *this,int param_1,int param_2,float *param_3)

{
  ...
  puVar2 = (ushort *)((this->cls_0x6b848c).mbr_0x1064 + (int)puVar1);
  for (; puVar1 < puVar2; puVar1 = puVar1 + 3) {
    *param_3 = (float)(uint)puVar1[2] * 1.525902e-05;
    param_3[1] = (float)(uint)puVar1[1] * 1.525902e-05;
    param_3[2] = (float)(uint)*puVar1 * 1.525902e-05;
    param_3[3] = 1.0;
    param_3 = param_3 + 4;
  }
...
cls_0x6b86d4 * __thiscall cls_0x6b86d4::cls_0x6b86d4(cls_0x6b86d4 *this,undefined4 *param_1)

{
  cls_0x6b848c::cls_0x6b848c(&this->cls_0x6b848c,param_1,0x30,1);
  (this->cls_0x6b848c).vftptr_0x0 =
       (cls_0x6b848c__vftable_6b848c *)&cls_0x6b86d4__vftable_6b86d4_006b86d4;
  return this;
}
