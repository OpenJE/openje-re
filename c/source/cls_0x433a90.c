#include "../include/cls_0x433a90.h"

cls_0x433a90 * __thiscall
cls_0x433a90::cls_0x433a90(cls_0x433a90 *this,_String_base *param_1,int param_2)

{
  ...
  *(int *)(iVar1 + -4 + (int)this) = iVar1 + -0xc;
  ...
  pcVar2 = "EscapeMenu.int";
  do {
    pcVar3 = pcVar2;
    pcVar2 = pcVar3 + 1;
  } while (*pcVar3 != '\0');
  ::cls_0x50db20::meth_0x401bd0
            ((cls_0x50db20 *)&local_28,"EscapeMenu.int",(uint)(pcVar3 + -0x653e64));
  local_4._0_1_ = 2;
  ...
  local_14 = 0;
  local_24 = (void *)((uint)local_24 & 0xffffff00);
  pcVar2 = "EscapeMenuWin";
  do {
    pcVar3 = pcVar2;
    pcVar2 = pcVar3 + 1;
  } while (*pcVar3 != '\0');
  ::cls_0x50db20::meth_0x401bd0
            ((cls_0x50db20 *)&local_28,"EscapeMenuWin",(uint)(pcVar3 + -0x653e54));
