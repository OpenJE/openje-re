#include "../include/cls_0x6b85e4.h"

void __thiscall
cls_0x6b85e4::virt_meth_0x5d858a(cls_0x6b85e4 *this,uint param_1,uint param_2,int param_3)
...
/* WARNING: Removing unreachable block (ram,0x005d9ba2) */

void __thiscall
cls_0x6b85e4::virt_meth_0x5d9b5c(cls_0x6b85e4 *this,int param_1,int param_2,float *param_3)

{
  ...
  for (; puVar2 < puVar1; puVar2 = puVar2 + 1) {
    *param_3 = (float)(*puVar2 & 0xffff) * 1.525902e-05;
    param_3[1] = (float)(uint)*(ushort *)((int)puVar2 + 2) * 1.525902e-05;
    param_3[2] = 1.0;
    param_3[3] = 1.0;
    param_3 = param_3 + 4;
  }
...
cls_0x6b85e4 * __thiscall cls_0x6b85e4::cls_0x6b85e4(cls_0x6b85e4 *this,undefined4 *param_1)

{
  cls_0x6b848c::cls_0x6b848c(&this->cls_0x6b848c,param_1,0x20,1);
  (this->cls_0x6b848c).vftptr_0x0 =
       (cls_0x6b848c__vftable_6b848c *)&cls_0x6b85e4__vftable_6b85e4_006b85e4;
  return this;
}
