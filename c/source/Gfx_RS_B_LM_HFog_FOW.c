#include "../include/Gfx_RS_B_LM_HFog_FOW.h"

Gfx_RS_B_LM_HFog_FOW * __thiscall
Gfx_RS_B_LM_HFog_FOW::~Gfx_RS_B_LM_HFog_FOW(Gfx_RS_B_LM_HFog_FOW *this)

{
  ...
  undefined *puStack_8;
  undefined4 local_4;
  Gfx_RS_B_LM_HFog_FOW *pGVar2;
  
  puStack_8 = &LAB_00637218;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  (this->Gfx_RenderStyle).vftptr_0x0 =
       (Gfx_RenderStyle__vftable_67c558 *)&Gfx_RS_B_LM_HFog_FOW__vftable_67c7b0_0067c7b0;
  local_4 = 0;
  pGVar2 = DAT_0070bcc4;
  if (DAT_0070bcc4 != (Gfx_RS_B_LM_HFog_FOW *)0x0) {
    pGVar2 = (Gfx_RS_B_LM_HFog_FOW *)((int)&DAT_0070bcc4[-1].mbr_0x18 + 3);
    DAT_0070bcc4 = pGVar2;
    if (pGVar2 == (Gfx_RS_B_LM_HFog_FOW *)0x0) {
      if (DAT_0070bcc8 != (int *)0x0) {
        (**(code **)(*DAT_0070bcc8 + 8))(DAT_0070bcc8);
        DAT_0070bcc8 = (int *)0x0;
      }
      pGVar2 = DAT_0070bccc;
      if (DAT_0070bccc != (Gfx_RS_B_LM_HFog_FOW *)0x0) {
        uVar1 = (*((DAT_0070bccc->Gfx_RenderStyle).vftptr_0x0)->virt_meth_0x6162e5_8)(DAT_0070bccc);
        pGVar2 = (Gfx_RS_B_LM_HFog_FOW *)CONCAT31(extraout_var,uVar1);
        DAT_0070bccc = (Gfx_RS_B_LM_HFog_FOW *)0x0;
      }
    }
  }
...
Gfx_RS_B_LM_HFog_FOW::virt_meth_0x5376c0(Gfx_RS_B_LM_HFog_FOW *this,byte param_1)

{
  ~Gfx_RS_B_LM_HFog_FOW(this);
  if ((param_1 & 1) != 0) {
...
Gfx_RS_B_LM_HFog_FOW * __thiscall
Gfx_RS_B_LM_HFog_FOW::Gfx_RS_B_LM_HFog_FOW
          (Gfx_RS_B_LM_HFog_FOW *this,dword param_1,dword param_2,dword param_3,dword param_4,
          dword param_5)
...
int __thiscall
Gfx_RS_B_LM_HFog_FOW::SetMaterial(Gfx_RS_B_LM_HFog_FOW *this,void *param_1,int param_2,int param_3)

{
  ...
  if ((local_1dc[0] == '\0') && (uStack_1e0._3_1_ == '\0')) {
    this->mbr_0x4 = DAT_0070bcc8;
  }
  else {
    this->mbr_0x4 = DAT_0070bccc;
  }
  if (this->mbr_0x4 == 0) {
    FUN_00497120((byte *)"Gfx_RS_B_LM_HFog_FOW::SetMaterial() failed - not created yet.");
    ExceptionList = pvStack_c;
    return -0x7789f794;
  }
  if (param_2 == 0) {
    FUN_00497120((byte *)"Gfx_RS_B_LM_HFog_FOW: No HeightFog object specified!");
    ExceptionList = pvStack_c;
    return -0x7789f794;
  }
  if (*(int *)((int)param_1 + 0x130) == 0) {
    cls_0x490060::meth_0x503390((cls_0x490060 *)&DAT_007082f8,(int *)0x0,0);
    FUN_00497120((byte *)"Gfx_RS_B_LM_HFog_FOW: NULL Base Texture handle\n");
  }
  else {
    ...
    if (piVar2 == (int *)0x0) {
      ...
      local_4 = 0;
      FUN_00497120((byte *)"Gfx_RS_B_LM_HFog_FOW: Cannot find Base Texture %s");
      local_4 = 0xffffffff;
  ...
  if (*(int *)((int)param_1 + 0x134) == 0) {
    ...
    if (piVar2 == (int *)0x0) {
      ...
      FUN_004ab1c0((void *)0x0,(cls_0x50db20 *)&local_1a8);
      local_4 = 1;
      FUN_00497120((byte *)"Gfx_RS_B_LM_HFog_FOW: Cannot find Lightmap %s");
      local_4 = 0xffffffff;
      cls_0x4d8d70::meth_0x4b2dd0(&local_1a8);
    }
    else {
  ...
  if (*(int *)(param_2 + 0x44) == 0) {
    ...
    pcVar16 = "Gfx_RS_B_LM_HFog_FOW: Height Fog map not created!";
  }
  else {
    ...
    (**(code **)(*(int *)this->mbr_0x4 + 0x54))();
    pcVar16 = "Gfx_RS_B_LM_HFog_FOW: Height Fog map not found!";
  }
  puStack_204 = (undefined *)0x54027c;
...
LAB_0054027f:
  ...
  pcStack_27c = "LMaop";
  puStack_284 = (undefined4 *)0x5403cd;
  ...
  puStack_2b0 = (undefined *)0x540500;
  ...
  if (DAT_0070bcdd != '\0') {
    ...
    if (iVar3 < 0) {
      handle_fatal_error("Gfx_RS_B_LM_HFog_FOW::SetMaterial - Failed to find valid technique (%x)\n"
                        );
    }
    else {
      DAT_0070bcdd = '\0';
      DAT_0070bcd8 = uStack_158;
      DAT_0070bce0 = uStack_154;
    }
  }
  ExceptionList = pvStack_c;
  return iVar3;
