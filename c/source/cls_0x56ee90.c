#include "../include/cls_0x56ee90.h"

undefined4 * __thiscall cls_0x56ee90::meth_0x56ee90(cls_0x56ee90 *this,int param_1)

{
  ...
  if (*(char *)((int)(undefined4 *)local_8[1] + 0x4d) == '\0') {
...
LAB_0056ef1d:
        ...
        if (uVar4 == 0) goto LAB_0056ef0e;
LAB_0056ef1b:
        if ((int)uVar4 < 0) goto LAB_0056ef1d;
        puVar6 = (undefined4 *)*puVar5;
        local_8 = puVar5;
      }
      puVar5 = puVar6;
    } while (*(char *)((int)puVar6 + 0x4d) == '\0');
  }
  return local_8;
}
...
void __thiscall cls_0x56ee90::meth_0x56f4b0(cls_0x56ee90 *this,undefined4 *param_1,void *param_2)

{
  ...
  puVar1 = meth_0x56ee90(this,(int)param_2);
