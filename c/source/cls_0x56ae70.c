#include "../include/cls_0x56ae70.h"

void __thiscall
cls_0x56ae70::meth_0x56a6f0
          (cls_0x56ae70 *this,int **param_1,char param_2,int **param_3,undefined4 *param_4)

{
  ...
  ExceptionList = &local_c;
  ppiVar6 = (int **)FUN_0056a650(this->mbr_0x4,param_3,this->mbr_0x4,param_4,0);
...
void __thiscall cls_0x56ae70::meth_0x56a8d0(cls_0x56ae70 *this,undefined4 *param_1,int **param_2)

{
  ...
  if (local_4) {
    if (ppiVar5 == (int **)*ppiVar1) {
      puVar4 = (undefined4 *)meth_0x56a6f0(this,(int **)&param_2,'\x01',ppiVar5,ppiVar2);
      *param_1 = *puVar4;
  ...
  if (param_2[3] < *ppiVar2) {
    puVar4 = (undefined4 *)meth_0x56a6f0(this,(int **)&param_2,local_4,ppiVar5,ppiVar2);
    *param_1 = *puVar4;
    *(undefined *)(param_1 + 1) = 1;
    return;
  }
...
int __thiscall cls_0x56ae70::meth_0x56acb0(cls_0x56ae70 *this,int **param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_00638af0;
  pvStack_c = ExceptionList;
  ExceptionList = &pvStack_c;
  pcVar2 = cls_0x56a4c0::cls_0x56a4c0((cls_0x56a4c0 *)local_40);
  local_28[0] = *param_1;
  local_4 = 0;
  cls_0x56a4c0::cls_0x56a4c0((cls_0x56a4c0 *)(local_28 + 1),(int)pcVar2);
  local_4._0_1_ = 1;
  piVar3 = (int *)meth_0x56a8d0(this,local_48,local_28);
  iVar1 = *piVar3;
  local_4 = (uint)local_4._1_3_ << 8;
  cls_0x56a4c0::meth_0x56a540((cls_0x56a4c0 *)(local_28 + 1));
  local_4 = 0xffffffff;
  cls_0x56a4c0::meth_0x56a540((cls_0x56a4c0 *)local_40);
  ExceptionList = pvStack_c;
  return iVar1 + 0x10;
}
...
int __thiscall cls_0x56ae70::meth_0x56ad40(cls_0x56ae70 *this)

{
  ...
  meth_0x56acb0(this,(int **)&stack0x00000000);
  return dVar1;
}



cls_0x56ae70 * __thiscall cls_0x56ae70::cls_0x56ae70(cls_0x56ae70 *this)

{
  ...
  byte local_15;
  int *local_14;
  cls_0x56ae70 *local_10;
  void *local_c;
  undefined *puStack_8;
  undefined4 local_4;
  
  local_4 = 0xffffffff;
  puStack_8 = &LAB_00638b08;
  local_c = ExceptionList;
  ExceptionList = &local_c;
