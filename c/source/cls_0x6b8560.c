#include "../include/cls_0x6b8560.h"

void __thiscall
cls_0x6b8560::virt_meth_0x5d7e5c(cls_0x6b8560 *this,uint param_1,uint param_2,int param_3)
...
void __thiscall
cls_0x6b8560::virt_meth_0x5d9927(cls_0x6b8560 *this,int param_1,int param_2,float *param_3)

{
  ...
  for (; puVar2 < puVar1; puVar2 = puVar2 + 1) {
    *param_3 = (float)((*puVar2 & 0x7c00) >> 10) * 0.03225806;
    param_3[1] = (float)((*puVar2 & 0x3e0) >> 5) * 0.03225806;
    param_3[2] = (float)(*(byte *)puVar2 & 0x1f) * 0.03225806;
    param_3[3] = (float)(uint)(*puVar2 >> 0xf);
    param_3 = param_3 + 4;
  }
...
cls_0x6b8560 * __thiscall cls_0x6b8560::cls_0x6b8560(cls_0x6b8560 *this,undefined4 *param_1)

{
  cls_0x6b848c::cls_0x6b848c(&this->cls_0x6b848c,param_1,0x10,1);
  (this->cls_0x6b848c).vftptr_0x0 =
       (cls_0x6b848c__vftable_6b848c *)&cls_0x6b8560__vftable_6b8560_006b8560;
  return this;
}
