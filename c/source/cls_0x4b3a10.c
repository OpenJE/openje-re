#include "../include/cls_0x4b3a10.h"

void __thiscall cls_0x4b3a10::meth_0x4b3a10(cls_0x4b3a10 *this,uint param_1)
...
void __thiscall cls_0x4b3a10::meth_0x4b42f0(cls_0x4b3a10 *this,int param_1,undefined4 *param_2)

{
  int iVar1;
  
  iVar1 = FUN_00433760(param_1,*(undefined4 *)(param_1 + 4),param_2);
  meth_0x4b3a10(this,1);
  *(int *)(param_1 + 4) = iVar1;
  **(int **)(iVar1 + 4) = iVar1;
  return;
}
