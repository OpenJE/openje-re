#include "../include/cls_0x6b86a4.h"

void __thiscall
cls_0x6b86a4::virt_meth_0x5d90dc(cls_0x6b86a4 *this,uint param_1,uint param_2,int param_3)

{
  ...
  if ((this->cls_0x6b848c).mbr_0x1058 != 0) {
    ...
    puVar5 = extraout_EDX;
    do {
      fVar1 = *(float *)(dVar3 + ((param_2 & 3) + (param_1 & 3) * 8) * 4 + (local_c & 3) * 4);
...
/* WARNING: Removing unreachable block (ram,0x005da4f0) */

void __thiscall
cls_0x6b86a4::virt_meth_0x5da456(cls_0x6b86a4 *this,int param_1,int param_2,float *param_3)

{
  ...
  for (; puVar3 < puVar1; puVar3 = puVar3 + 1) {
    ...
    *param_3 = (float)(int)((short)(*(short *)puVar3 << 6) >> 6) * 0.001953125;
    param_3[1] = (float)(int)((short)((short)(uVar2 >> 10) << 6) >> 6) * 0.001953125;
    param_3[2] = (float)(int)((short)((ushort)(uVar2 >> 0x14) << 6) >> 6) * 0.001953125;
    param_3[3] = (float)(*puVar3 >> 0x1e) * 0.3333333;
    param_3 = param_3 + 4;
  }
...
cls_0x6b86a4 * __thiscall cls_0x6b86a4::cls_0x6b86a4(cls_0x6b86a4 *this,undefined4 *param_1)

{
  cls_0x6b848c::cls_0x6b848c(&this->cls_0x6b848c,param_1,0x20,2);
  (this->cls_0x6b848c).vftptr_0x0 =
       (cls_0x6b848c__vftable_6b848c *)&cls_0x6b86a4__vftable_6b86a4_006b86a4;
  return this;
}
